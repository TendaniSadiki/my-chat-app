...
export default function NavLinks(props){
    return(
            ...
            <Link to="/messages" onClick={() => props.isMobile && props.closeMobileMenu()} ><span><i><CgT className="fas fa-wrench"/><h4>Settings</h4></i></span>
            </Link>
            <Link to="/signin" onClick={() => props.isMobile && props.closeMobileMenu()} ><span><i><CgLogOut className="fas fa-sign-out-alt" ><h4>Log Out</h4></i></span>
            </Link>
            </div>
