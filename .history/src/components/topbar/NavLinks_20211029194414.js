...
export default function NavLinks(props){
    return(
            ...
            <Link to="/home" onClick={() => props.isMobile && props.closeMobileMenu()}><span><i><CgHome className="fas fa-home" /></i></span>
            </Link>
            <Link to="/profile" onClick={() => props.isMobile && props.closeMobileMenu()} ><span><i ><CgUserlane className="fas fa-user-circle" /></i></span>
            </Link>
