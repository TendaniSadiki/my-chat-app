...
import {CgUserL} from "react-icons/cg";
...
export default function NavLinks(props){
    return(
            ...
            <Link to="/profile" onClick={() => props.isMobile && props.closeMobileMenu()} ><span><i ><CgUser className="fas fa-user-circle" /><h4>Profile</h4></i></span>
            </Link>
