...
function personal({formData, setFormData}) {
    ...
    return (
        <div>
         ...
         onChange={(event) => setFormData({...formData, firstname: event.target.value})} useRef={firstname}
         
          required />
          </div>
          <div class="input-cnt">
          <input placeholder="Surname" type="text" autoComplete="true" name="surname" value={formData.surname} 
         onChange={(event) => setFormData({...formData, surname: event.target.value})} useRef={surname}
         
          required />
          </div>
          <div class="input-cnt">
          <input placeholder="Username" type="text" autoComplete="true"  name="name" value={formData.username} 
         onChange={(event) => setFormData({...formData, username: event.target.value})} useRef={username}
